...
def broken_powerlaw_two_peaks(m1,mMin,mMax,m_break,alpha_1,alpha_2,mu_1,sig_1,mu_2,sig_2,lam_0,lam_1):
    ...
    p ~ m^alpha (see ``jutils.broken_powerlaw``), so the GWTC-5.0 median
    ...
    p_m1_bpl = jutils.broken_powerlaw(m1,mMin,mMax,m_break,alpha_1,alpha_2)
    p_m1_peak_1 = jutils.gaussian(m1,mu_1,sig_1)
    p_m1_peak_2 = jutils.gaussian(m1,mu_2,sig_2)
